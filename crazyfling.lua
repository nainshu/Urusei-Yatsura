...
inputBox.Text = ""
inputBox.PlaceholderText = "输入昵称, all, nonfriends"
...
phase2Button4.Text = "Xeno 防弹飞：关闭"
...
local function toggleXenoAntiFling()
    ...
    if XenoAntiFlingEnabled then
        phase2Button4.Text = "Xeno 防弹飞：开启"
