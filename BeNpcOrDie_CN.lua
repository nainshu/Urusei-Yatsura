...
if game.GameId == 4019583467 then
    ...
    local Window =
        ...
        Title = "成为NPC或死",
        SubTitle = "作者 Bac0nH1ckOff | t.me/arceusxscripts",
        TabWidth = 160,
    ...
    if game.PlaceId == 11276071411 then
        ...
        local farmToggle = Tabs.Farm:CreateToggle("farmToggle", {Title = "金钱刷取", Default = false})
        ...
        local resetParagraph = Tabs.Farm:CreateParagraph("重置", {
            Title = "自动重置：",
            Content = ""
        })
        
        local full = Tabs.Farm:CreateToggle("full", { Title = "背包满时自动重置", Default = false })
        local sheriff  = Tabs.Farm:CreateToggle("sheriff", { Title = "当你是警长时重置", Default = false })
        ...
        local serverHopToggle = Tabs.Farm:CreateToggle("serverHopToggle", {Title = "自动切换服务器", Default = false})
        ...
        local ToggleESP = Tabs.Main:CreateToggle("ToggleESP", {Title = "透视", Default = false})
        local AutoObby = Tabs.Main:CreateToggle("AutoObby", {Title = "自动完成障碍", Default = false})
        local AutoTask2 = Tabs.Main:CreateToggle("AutoTask2", {Title = "自动任务", Default = false})
        local AutoTask = Tabs.Main:CreateToggle("AutoTask", {Title = "自动最近任务", Default = false})
        ...
        local InstanceTask = Tabs.Main:CreateToggle("InstanceTask", {Title = "自动立即任务", Default = false})
        ...
        local ToggleSpeed = Tabs.Player:CreateToggle("ToggleSpeed", {Title = "速度开关", Default = false})
        local speedValue = 0
        local jumpValue = 0
        ...
        local ToggleJump = Tabs.Player:CreateToggle("ToggleJump", {Title = "跳跃力开关", Default = false})
        char:WaitForChild("Humanoid").UseJumpPower = true
        ...
        local Noclip = Tabs.Player:CreateToggle("穿墙", {Title = "穿墙", Default = false})
