...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/nainshu/no/main/UI.lua"))()
...
local evadeTab = window:Tab("Evade", "rbxassetid://139972859056573")
local evadeSection = evadeTab:section("脚本", true)

evadeSection:Button("Evade", function()
    pcall(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/nainshu/Urusei-Yatsura/refs/heads/main/evade.lua",true))()
    end)
end)